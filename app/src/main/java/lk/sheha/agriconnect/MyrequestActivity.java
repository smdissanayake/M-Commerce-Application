...
import lk.sheha.agriconnect.model.RequestAdapter;
...
public class MyrequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        RecyclerView view = findViewById(R.id.recycleViewRequests);
        view.setLayoutManager(new LinearLayoutManager(MyrequestActivity.this));
        RequestAdapter adapter = new RequestAdapter(list,MyrequestActivity.this);
        view.setAdapter(adapter);
//        list.add(new ReqestItem("sdf","sdf","sdf","sdf","sdf","ff","rrr","sdf"));
